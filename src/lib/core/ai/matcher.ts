...
import { haversineDistance } from '../commons/primitives/space'
import { availabilityWindowsOverlapWithTimezone } from '../commons/matching/matching'
import type { AvailabilityWindow, DayOfWeek, TimeRange } from '../commons/primitives/time'
...
export class Matcher {
  ...
  private computeConstraintFeasibility(
    ...
    // Quantity feasibility - only include if both sides have quantity constraints
  ...
  private computeQuantityFeasibility(
    ...
    // Both sides must have quantity (enforced by caller)
