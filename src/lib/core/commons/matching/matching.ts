...
import type { Resource, MatchRecord, Score } from './slot';
import type { AvailabilityWindow, TimeRange, DayOfWeek, DaySchedule, WeekSchedule, MonthSchedule } from '../primitives/time';
import { cellsCompatible, DEFAULT_SEARCH_RADIUS_KM, haversineDistance } from '../primitives/space';
