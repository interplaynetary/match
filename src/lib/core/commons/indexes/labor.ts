...
import { z } from 'zod';
import { AvailabilityWindowSchema, type AvailabilityWindow } from '../primitives/time';
import { SkillSchema, type Skill } from '../skills';
import type { Contact } from '../../types';
import { getSpaceTimeSignature, getTimeSignature } from '../primitives/space-time-keys';
import { PersonSchema, type Person } from '../person';
import { createHexIndex, addItemToHexIndex, queryHexIndex, queryHexIndexRadius, type HexIndex, type HexNode } from '../primitives/space-time-index';
